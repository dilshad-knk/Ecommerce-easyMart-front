      ...
      >
        ...
        <Offcanvas.Body>
          <Nav className="justify-content-end flex-grow-1 pe-3">
                ...
                <NavLink to='/sellers/SellerDashboard'  className={({isActive})  => (isActive ? 'text-decoration-none d-flex align-items-center text-white  activeLink px-2 me-2' : 'text-decoration-none d-flex align-items-center text-white px-2 me-2 bord-white')}>
